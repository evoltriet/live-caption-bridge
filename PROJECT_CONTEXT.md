...
- **Published prerelease 2026-08-12:** [`v0.1.0-alpha.1`](https://github.com/evoltriet/live-caption-bridge/releases/tag/v0.1.0-alpha.1) includes the unsigned Windows x64 installer, portable executable, portable ZIP, and SHA-256 manifest. The [release workflow](https://github.com/evoltriet/live-caption-bridge/actions/runs/31621687279) passed lint, strict typechecking, 19 unit/integration tests, Electron E2E, production builds, Windows packaging, checksum generation, and asset upload. Binary publication does not satisfy any field-validation gate.
