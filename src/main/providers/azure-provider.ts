...
import { isSupportedLocale } from '../../shared/contracts'
...
export class AzureSpeechProvider implements SpeechProvider {
  ...
  private toSegment(
    ...
    return {
      ...
      sourceLocale: locale,
      sourceText,
      englishText: locale === 'en-US' ? sourceText : englishTranslation || '',
      vietnameseText: locale === 'vi-VN' ? sourceText : vietnameseTranslation || '',
      isFinal,
